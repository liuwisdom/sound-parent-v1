...
public class phoneUtil {
    //数字秘钥
    private final static long SECRET_KEY = 104361;
    ...
    //总加密字符串长度
    private final static int LEN_KEY = 10;
    ...
    public static  String encrypt(String str){
        ...
        //数字校验
        if(!isNumber(str)){
            System.out.println(str + "手机号格式不正确");
            return null;
        }

        long number = Long.parseLong(str);
        long newNumber = number  * SECRET_KEY;
...
//        }
    ...
    /**
     * 功能描述 :随机生成一个微信号
     * 参数 :[lMin, lMax] :n目的是产生微信号的长度是多少
     * @return java.lang.String
     * @date  2022/1/24
     * @author  liuwisdom
     */
    public static String getWeixin(int lMin,int lMax){
    ...
    public static String getPassword(){
        return String.valueOf((int) Math.ceil(Math.random()*1000000000));
    }
    /**
     * 功能描述 :随机生成邀请码
     * 参数 :[lMin, lMax] :
    ...
    public static String getInvitationCode(){
        return String.valueOf((int) Math.ceil(Math.random()*10000));
    }
    /**
     * 功能描述 :随机生成手机号
     * 参数 :[] :
...
//        String number = "15517064589";
//        System.out.println(number);
//        String result = phoneUtil.encrypt(number);
//        System.out.println(result);
       System.out.println(phoneUtil.decrypt("e$CJMJJIJIAJDbJ$"));
      // phoneUtil.randomPhonNuber();
        System.out.println(phoneUtil.getPassword());
    }
